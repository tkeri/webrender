...
void write_color(vec4 color0,
    ...
    vColor10 = vec4(clamp(color1.rgb * modulate.z, vec3(0.0, 0.0, 0.0), vec3(color1.a, color1.a, color1.a)), color1.a);
    vColor11 = vec4(clamp(color1.rgb * modulate.w, vec3(0.0, 0.0, 0.0), vec3(color1.a, color1.a, color1.a)), color1.a);
}
