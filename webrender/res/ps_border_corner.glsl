...
void write_color(vec4 color0,
    ...
    vColor00 = vec4(clamp(color0.rgb * modulate.x, vec3(0.0, 0.0, 0.0), vec3(color0.a, color0.a, color0.a)), color0.a);
    vColor01 = vec4(clamp(color0.rgb * modulate.y, vec3(0.0, 0.0, 0.0), vec3(color0.a, color0.a, color0.a)), color0.a);
    vColor10 = vec4(clamp(color1.rgb * modulate.z, vec3(0.0, 0.0, 0.0), vec3(color1.a, color0.a, color0.a)), color1.a);
    vColor11 = vec4(clamp(color1.rgb * modulate.w, vec3(0.0, 0.0, 0.0), vec3(color1.a, color0.a, color0.a)), color1.a);
}
...
void main(in v2p IN, out p2f OUT) {
    ...
    SHADER_OUT(Target0, color * alpha);
}
#endif
