...
impl Renderer {
    ...
    pub fn new(window: &glutin::Window,
        ...
        /*let cs_line = device.create_clip_program(include_bytes!(concat!(env!("OUT_DIR"), "/cs_line.vert")),
                                                        include_bytes!(concat!(env!("OUT_DIR"), "/cs_line.frag")));*/
        ...
        let ps_line = create_programs!(device, "ps_line");
    ...
    fn submit_batch(&mut self,
...

        {
            let mut program = match batch.key.kind {
                ...
                AlphaBatchKind::Line => self.ps_line.get(transform_kind),
            };
